...
DEFAULT_COMMENTS_APP = 'tagging'


def get_comment_app():
    """
    Get the comment app (i.e. "tagging") as defined in the settings
    """
...
def get_model():
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_model"):
        ...
        from tagging.models import Comment
        return Comment


def get_form():
    from tagging.forms import CommentForm
    """
