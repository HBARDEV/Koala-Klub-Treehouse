...
moderation options::
    ...
    from tagging.moderation import CommentModerator, moderator
...
class Moderator:
    ...
    def connect(self):
        ...
        """
        signals.comment_will_be_posted.connect(self.pre_save_moderation, sender=tagging.get_model())
        signals.comment_was_posted.connect(self.post_save_moderation, sender=tagging.get_model())
