...
from tagging import get_model
from tagging.views.moderation import perform_flag, perform_approve, perform_delete
...
class CommentsAdmin(admin.ModelAdmin):
    ...
    def get_actions(self, request):
        ...
        if not request.user.has_perm('tagging.can_moderate'):
...
Klass = get_model()
if Klass._meta.app_label == "tagging":
