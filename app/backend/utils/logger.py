...
class TreeHouseLogger(logging.Logger):
    def __init__(self, *args, **kwargs):
        super(TreeHouseLogger, self).__init__(*args, **kwargs)
    ...
    def makeRecord(self, name, level, fn, lno, msg, args, exc_info, func=None, extra=None, sinfo=None):
        ...
        return super(TreeHouseLogger, self).makeRecord(name, level, fn, lno, msg, args, exc_info, func, extra, sinfo)
...
class TreeHouseJsonFormatter(jsonlogger.JsonFormatter):
    def add_fields(self, log_record, record, message_dict):
        super(TreeHouseJsonFormatter, self).add_fields(log_record, record, message_dict)

        # Map all shared_extra params to root level
        # @NOTE: we cannot map shared_extra in TreeHouseLogger, because not all loggers are TreeHouseLogger,
